...
<m:AfterLogin title="Renew Passport">
...
<link rel="stylesheet" href="${pageContext.request.contextPath}/styles/RenewalForm.css" />
    ...
    <jsp:attribute name="content" >
     <div class="form-container" >
        ...
        <form:form  modelAttribute="PassportRenewal" >
    	<h2 align="center" style="font-family:'Merriweather Sans',sans-serif;">Passport Renewal Form</h2>
            <table >
          		<tr>
          			<td>User ID</td>
          		...
          		<tr>
          			...
          			<td><form:input path="reasonForRenewal" placeholder="Reason For Renewal"></form:input></td>
          			<td> <form:errors path="reasonForRenewal" cssClass="error"></form:errors></td>
          		</tr>
                <tr>
                    <td>State:</td>
                    <td>
                        <form:select path="state" id="state" placeholder="Select State">
                ...
                <tr>
                    <td>Pincode:</td>
                    <td>
                        <form:select path="pincode" id="pincode">
                        </form:select></td>
                ...
                <tr>
                <td></td>
                    <td ><button class="btn btn-large" type="submit"  id="submit-button" style="background-color: rgb(0, 64, 128);color: white;" formaction="RenewPassport">Submit</button></td>
                </tr>
            </table>
        </form:form>
         </div>
