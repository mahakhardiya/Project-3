...
public class RenewalOfPassport {
	...
	public RenewalOfPassport(String userId, @NotBlank(message = "*Required") String reasonForRenewal,
			@NotBlank(message = "*Required") String state, @NotBlank(message = "*Required") String city,
			@NotNull(message = "*Required") Integer pincode, @NotBlank(message = "*Required") String typeOfService,
